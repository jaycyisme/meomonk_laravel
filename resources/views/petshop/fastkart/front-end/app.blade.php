...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <!-- bootstrap css -->
    <link id="rtl-link" rel="stylesheet" type="text/css" href="{{ asset('front-end/assets/css/vendors/bootstrap.css') }}" />

    <!-- wow css -->
    <link rel="stylesheet" href="{{ asset('front-end/assets/css/animate.min.css') }}" />

    <!-- Iconly css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('front-end/assets/css/bulk-style.css') }}" />
...
<body class="bg-effect">
    ...
    <!-- Loader End -->
    @include('petshop.fastkart.front-end.header')
    @yield('content')
    @include('petshop.fastkart.front-end.footer')
    ...
    <!-- Bootstrap js-->
    <script src="{{ asset('front-end/assets/js/bootstrap/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('front-end/assets/js/bootstrap/bootstrap-notify.min.js') }}"></script>
    <script src="{{ asset('front-end/assets/js/bootstrap/popper.min.js') }}"></script>

    <!-- feather icon js-->
    <script src="{{ asset('front-end/assets/js/feather/feather.min.js') }}"></script>
    <script src="{{ asset('front-end/assets/js/feather/feather-icon.js') }}"></script>

    <!-- Lazyload Js -->
    <script src="{{ asset('front-end/assets/js/lazysizes.min.js') }}"></script>

    <!-- Slick js-->
    <script src="{{ asset('front-end/assets/js/slick/slick.js') }}"></script>
    <script src="{{ asset('front-end/assets/js/slick/slick-animation.min.js') }}"></script>
    <script src="{{ asset('front-end/assets/js/slick/custom_slick.js') }}"></script>

    <!-- Auto Height Js -->
    <script src="{{ asset('front-end/assets/js/auto-height.js') }}"></script>

    <!-- Timer Js -->
    <script src="{{ asset('front-end/assets/js/timer1.js') }}"></script>

    <!-- Fly Cart Js -->
    <script src="{{ asset('front-end/assets/js/fly-cart.js') }}"></script>

    <!-- Quantity js -->
    <script src="{{ asset('front-end/assets/js/quantity-2.js') }}"></script>

    <!-- WOW js -->
    <script src="{{ asset('front-end/assets/js/wow.min.js') }}"></script>
    <script src="{{ asset('front-end/assets/js/custom-wow.js') }}"></script>
