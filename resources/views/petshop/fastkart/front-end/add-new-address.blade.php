                ...
                <div class="left-sidebar-box">
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="card-body">
                                <form class="theme-form theme-form-2 mega-form" action="{{ route('addresses.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        <label class="form-label-title col-sm-3 mb-0">Specific address</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="address_line_2" class="form-control" placeholder="Enter address line 2 (can null)">
                                        </div>
                                    </div>
