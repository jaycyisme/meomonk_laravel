        ...
        <div class="row">
            <div class="col-12">
                <div class="slider-6_1 product-wrapper">
                    @foreach($services_related as $service_related)

                    <div>
                        <div class="product-box-3 wow fadeInUp">
                            <div class="product-header">
                                <div class="product-image">
                                    <a href="{{ route('productDetail', ['id' => $service_related->id]) }}">
                                        <img src="{{ asset('front-end/assets/images/product/' . $service_related->image) }}"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    ...
                                    <ul class="product-option">
                                        ...
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="Wishlist">
                                            <form action="{{ route('wishlist.add') }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="id" value="{{ $service_related->id }}">
                            ...
                            <div class="product-footer">
                                <div class="product-detail">
                                    <span class="span-name">{{ $service_related->category->name }}</span>
                                    <a href="{{ route('productDetail', ['id' => $service_related->id]) }}">
                                        <h5 class="name">{{ $service_related->name }}</h5>
                                    </a>
                                    ...
                                    <h5 class="price"><span class="theme-color">${{ $service_related->price }}</span>
                                        {{-- <del>$12.57</del> --}}
                                    </h5>
