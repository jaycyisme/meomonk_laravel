        ...
        <div class="row">
            <div class="col-xxl-6 col-xl-5 col-lg-6 d-lg-block d-none ms-auto">
                <div class="image-contain">
                    <img src="{{asset('front-end')}}/assets/images/inner-page/otp.png" class="img-fluid" alt="">
                </div>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-center h-100">
                    <div class="log-in-box">
                        <div class="log-in-title">
                            ...
                            <h5 class="text-content">A code has been sent to <span>your email</span></h5>
                        </div>

                        <form action="{{ route('verifyOtp') }}" method="POST">
                            @csrf
                            <div id="otp" class="inputs d-flex flex-row justify-content-center">
                                <input class="text-center form-control rounded" type="text" id="otp" name="otp" maxlength="6" placeholder="Enter OTP">
                            </div>
