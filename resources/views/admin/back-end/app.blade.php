                ...
                <div>
                    <div class="logo-wrapper logo-wrapper-center">
                        <a href="index.html" data-bs-original-title="" title="">
                            <img class="img-fluid for-white" src="{{ asset('back-end/assets/images/logo/full-white.png') }}" alt="logo">
                        </a>
                        <div class="back-btn">
                            ...
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        ...
                                        <li>
                                            <a href="{{ route('addNewProducts') }}">Add New Products</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        ...
                                        <li>
                                            <a href="{{ route('addNewCategory') }}">Add New Category</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="{{ route('attributes') }}">Attributes</a>
                                        </li>

                                        <li>
                                            <a href="{{ route('addNewAttributes') }}">Add Attributes</a>
                                        </li>
                                    </ul>
                                </li>
...
<!--                                        </li>-->
                                        ...
                                        <li>
                                            <a href="{{ route('currencyRates') }}">Currency Rates</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="{{ route('couponList') }}">Coupon List</a>
                                        </li>
...
<!--                                </li>-->
                                ...
                                <li class="sidebar-list">
                                    <a class="sidebar-link sidebar-title link-nav" href="{{ route('productReview') }}">
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="{{ route('profileSetting') }}">Profile Setting</a>
                                        </li>
                                    </ul>
                                </li>

                                <li class="sidebar-list">
                                    <a class="sidebar-link sidebar-title link-nav" href="{{ route('reportList') }}">
...
<!--                                </li>-->
    ...
    <!-- Data table js -->
    <script src="{{ asset('back-end/assets/js/jquery.dataTables.js') }}"></script>
    <script src="{{ asset('back-end/assets/js/custom-data-table.js') }}"></script>
